...
These fixtures are reviewed, sanitized artifacts retained for parser and
portal-boundary tests. Identifiers and personal data are synthetic or redacted.
The files contain no reusable authentication material.
...
## Current-turn discovery fixtures

Supported structural facts are limited to the stable authenticated path
